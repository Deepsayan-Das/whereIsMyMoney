            ...
            <View className='w-full rounded-3xl bg-primary justify-evenly items-center border-2 border-[#f7f7ff] py-12 gap-y-2'>
              ...
              <View className='items-center mb-4'>
                <Image
                  ...
                  resizeMode='contain'
                />
                <Text className='text-text-primary font-black text-3xl tracking-tighter'>WIMM</Text>
              </View>
              <Text className='text-text-secondary font-bold text-3xl'>Create Account</Text>
              <Text className='text-text-muted text-base mb-4'>Sign up to get started</Text>
